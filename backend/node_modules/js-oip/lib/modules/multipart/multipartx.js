...
class MultipartX {
  ...
  fromString(jsonString) {
    const chunks = []; // ToDo:: FLODATA_MAX_LEN vs CHOP_MAX_LEN
    ...
    const max = chunks.length - 1; // We can do part, max, and data here | ref, sig, and addr are done in publisher
    ...
    for (let i = 0; i < chunks.length; i++) {
      ...
      const mps = new _mpsingle.default(tmpObj);
      multiparts.push(mps);
    }
  ...
  toString() {
    ...
    for (const mp of this.multiparts) {
