...
var _blockexplorer = _interopRequireDefault(require("blockchain.info/blockexplorer"));

var _pushtx = _interopRequireDefault(require("blockchain.info/pushtx"));
...
var renameKeys = function renameKeys(keysMap, obj) {
  return Object.keys(obj).reduce(function (acc, key) {
    return _objectSpread({}, acc, {}, (0, _defineProperty2["default"])({}, keysMap[key] || key, obj[key]));
  }, {});
};
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _blockexplorer["default"].getBlock(hash);
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.prev = 0;
                _context5.next = 3;
                return _blockexplorer["default"].getTx(txid);

              case 3:
                response = _context5.sent;
                _context5.next = 6;
                return _blockexplorer["default"].getBlockHeight(response.block_height);

              case 6:
                blockhash = _context5.sent;
                _context5.t0 = _objectSpread;
                _context5.t1 = {};
                _context5.t2 = response;
                _context5.t3 = response.hash;
                _context5.t4 = response.ver;
                _context5.next = 14;
                return blockhash.blocks[0].hash;

              case 14:
                _context5.t5 = _context5.sent;
                _context5.t6 = {
                  txid: _context5.t3,
                  version: _context5.t4,
                  blockhash: _context5.t5
                };
                response = (0, _context5.t0)(_context5.t1, _context5.t2, _context5.t6);
                return _context5.abrupt("return", response);

              case 20:
                _context5.prev = 20;
                _context5.t7 = _context5["catch"](0);
                throw this.createErrorString('getTransaction', _context5.t7);
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                _context7.prev = 3;
                _context7.next = 6;
                return _blockexplorer["default"].getAddress(address);

              case 6:
                response = _context7.sent;
                data = renameKeys(keys, response); // console.log({ response, data })
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.prev = 0;
                _context9.next = 3;
                return _blockexplorer["default"].getUnspentOutputs(address);
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _context14.prev = 2;
                _context14.next = 5;
                return _pushtx["default"].pushtx(rawtx);
